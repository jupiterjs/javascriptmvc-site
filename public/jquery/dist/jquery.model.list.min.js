...
[].push;n({pop:[].pop,shift:[].shift,unshift:[].unshift,splice:[].splice,sort:[].sort,reverse:[].reverse},function(a,b){e.Model.List.prototype[a]=function(){this._changed=true;return b.apply(this,arguments)}});n(["each","map"],function(a,b){e.Model.List.prototype[b]=function(d,f){return e[b](this,d,f)}})})(jQuery);
