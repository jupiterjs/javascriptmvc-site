...
d.renderer(h,o);if(e.cache)e.cached[h]=o;return{view:o}};if(g=document.getElementById(c))a=g.type.match(/\/[\d\w]+$/)[0].replace(/^\//,".");if(!a){a=e.ext;c+=e.ext}h=j(c);if(c.match(/^\/\//)){var m=c.substr(2);c=typeof steal==="undefined"?(c="/"+m):steal.root.mapJoin(m)}d=e.types[a];return{send:function(o,p){if(e.cached[h])return p(200,"success",{view:e.cached[h]});else if(g)p(200,"success",l(g.innerHTML));else i=f.ajax({async:b.async,url:c,dataType:"text",error:function(){w("",c);p(404)},success:function(x){w(x,
c);p(200,"success",l(x))}})},abort:function(){i&&i.abort()}}});f.extend(e,{hookups:{},hookup:function(a){var b=++n;e.hookups[b]=a;return b},cached:{},cache:true,register:function(a){this.types["."+a.suffix]=a;window.steal&&steal.type(a.suffix+" view js",function(b,c,d){c=e.types["."+b.type];var g=j(b.rootSrc);b.text=c.script(g,b.text);d()})},types:{},ext:".ejs",registerScript:function(a,b,c){return"$.View.preload('"+b+"',"+e.types["."+a].script(b,c)+");"},preload:function(a,b){e.cached[a]=function(c,
d){return b.call(c,c,d)}}});window.steal&&steal.type("view js",function(a,b,c){b=e.types["."+a.type];var d=j(a.rootSrc);a.text="steal('"+(b.plugin||"jquery/view/"+a.type)+"').then(function($){$.View.preload('"+d+"',"+a.text+");\n})";c()});var y,r,z,A,s,B,t,D={val:true,text:true};y=function(a){var b=f.fn[a];f.fn[a]=function(){var c=k(arguments),d,g,h=this;if(q(c[0])){c[0].done(function(i){r.call(h,[i],b)});return this}else if(z(c)){if(d=B(c)){g=c[d];c[d]=function(i){r.call(h,[i],b);g.call(h,i)};e.apply(e,
