(function(d){var n=d.isArray,t=function(h){var c=0;for(var a in h)c++;return c};d.Object={};var r=d.Object.same=function(h,c,a,b,f,e){var g=typeof h,k=n(h),j=typeof a;if(j=="string"||a===null){a=p[a];j="function"}if(j=="function")return a(h,c,b,f);a=a||{};if(e===-1)return g==="object"||h===c;if(g!==typeof c||k!==n(c))return false;if(h===c)return true;if(k){if(h.length!==c.length)return false;for(e=0;e<h.length;e++){b=a[e]===undefined?a["*"]:a[e];if(!r(h[e],c[e],h,c,b))return false}return true}else if(g===
"object"||g==="function"){f=d.extend({},c);for(var m in h){b=a[m]===undefined?a["*"]:a[m];if(!r(h[m],c[m],b,h,c,e===false?-1:undefined))return false;delete f[m]}for(m in f)if(a[m]===undefined||!r(undefined,c[m],a[m],h,c,e===false?-1:undefined))return false;return true}return false};d.Object.subsets=function(h,c,a){var b=c.length,f=[];t(h);for(var e=0;e<b;e++){var g=c[e];d.Object.subset(h,g,a)&&f.push(g)}return f};d.Object.subset=function(h,c,a){a=a||{};for(var b in c)if(!r(h[b],c[b],a[b],h,c))return false;
return true};var p={"null":function(){return true},i:function(h,c){return(""+h).toLowerCase()==(""+c).toLowerCase()}}})(jQuery);
(function(d){var n={undHash:/_|-/,colons:/::/,words:/([A-Z]+)([A-Z][a-z])/g,lowUp:/([a-z\d])([A-Z])/g,dash:/([a-z\d])([A-Z])/g,replacer:/\{([^\}]+)\}/g,dot:/\./},t=function(c,a,b){return c[a]!==undefined?c[a]:b&&(c[a]={})},r=function(c){var a=typeof c;return c&&(a=="function"||a=="object")},p,h=d.String=d.extend(d.String||{},{getObject:p=function(c,a,b){c=c?c.split(n.dot):[];var f=c.length,e,g,k,j=0;a=d.isArray(a)?a:[a||window];if(f==0)return a[0];for(;e=a[j++];){for(k=0;k<f-1&&r(e);k++)e=t(e,c[k],
b);if(r(e)){g=t(e,c[k],b);if(g!==undefined){b===false&&delete e[c[k]];return g}}}},capitalize:function(c){return c.charAt(0).toUpperCase()+c.substr(1)},camelize:function(c){c=h.classize(c);return c.charAt(0).toLowerCase()+c.substr(1)},classize:function(c,a){c=c.split(n.undHash);for(var b=0;b<c.length;b++)c[b]=h.capitalize(c[b]);return c.join(a||"")},niceName:function(c){return h.classize(c," ")},underscore:function(c){return c.replace(n.colons,"/").replace(n.words,"$1_$2").replace(n.lowUp,"$1_$2").replace(n.dash,
"_").toLowerCase()},sub:function(c,a,b){var f=[];b=typeof b=="boolean"?!b:b;f.push(c.replace(n.replacer,function(e,g){e=p(g,a,b);if(r(e)){f.push(e);return""}else return""+e}));return f.length<=1?f[0]:f},_regs:n})})(jQuery);
...
var f=a.dataTypes[0],e;return{send:function(g,k){e=setTimeout(function(){var j=a.fixture(b,a,g);if(!d.isArray(j)){var m=[{}];m[0][f]=j;j=m}typeof j[0]!="number"&&j.unshift(200,"success");if(!j[2]||!j[2][f]){m={};m[f]=j[2];j[2]=m}k.apply(null,j)},d.fixture.delay)},abort:function(){clearTimeout(e)}}});var n=[],t=function(a,b){for(var f=0;f<n.length;f++)if(h._similar(a,n[f],b))return f;return-1},r=function(a){var b=t(a);if(b>-1){a.fixture=n[b].fixture;return h._getData(n[b].url,a.url)}},p=function(a){var b=
a.data.id;if(b===undefined&&typeof a.data==="number")b=a.data;b===undefined&&a.url.replace(/\/(\d+)(\/|$|\.)/g,function(f,e){b=e});if(b===undefined)b=a.url.replace(/\/(\w+)(\/|$|\.)/g,function(f,e){if(e!="update")b=e});if(b===undefined)b=Math.round(Math.random()*1E3);return b},h=d.fixture=function(a,b){if(b!==undefined){if(typeof a=="string"){var f=a.match(/(GET|POST|PUT|DELETE) (.+)/i);a=f?{url:f[2],type:f[1]}:{url:a}}f=t(a,!!b);f>-1&&n.splice(f,1);if(b!=null){a.fixture=b;n.push(a)}}},c=d.String._regs.replacer;
...
{location:a.url+"/"+p(a)}]},"-restDestroy":function(){return{}},"-restCreate":function(a,b,f,e){e=e||parseInt(Math.random()*1E5,10);return[200,"succes",{id:e},{location:a.url+"/"+e}]},make:function(a,b,f,e){if(typeof a==="string")a=[a+"s",a];for(var g=d.fixture["~"+a[0]]=[],k=function(i){for(var l=0;l<g.length;l++)if(i==g[l].id)return g[l]},j=0;j<b;j++){var m=f(j,g);if(!m.id)m.id=j;g.push(m)}d.fixture["-"+a[0]]=function(i){var l=g.slice(0);i.data=i.data||{};d.each((i.data.order||[]).slice(0).reverse(),
...
a.success.apply(null,a.fixture(a,"success"));a.complete&&a.complete.apply(null,a.fixture(a,"complete"))},d.fixture.delay);return true}return false}})(jQuery);
