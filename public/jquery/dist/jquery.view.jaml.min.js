...
g.renderer(i,r);if(f.cache)f.cached[i]=r;return{view:r}};if(h=document.getElementById(d))a=h.type.match(/\/[\d\w]+$/)[0].replace(/^\//,".");if(!a){a=f.ext;d+=f.ext}i=e(d);if(d.match(/^\/\//)){var p=d.substr(2);d=typeof steal==="undefined"?(d="/"+p):steal.root.mapJoin(p)}g=f.types[a];return{send:function(r,s){if(f.cached[i])return s(200,"success",{view:f.cached[i]});else if(h)s(200,"success",o(h.innerHTML));else l=b.ajax({async:c.async,url:d,dataType:"text",error:function(){m("",d);s(404)},success:function(x){m(x,
d);s(200,"success",o(x))}})},abort:function(){l&&l.abort()}}});b.extend(f,{hookups:{},hookup:function(a){var c=++q;f.hookups[c]=a;return c},cached:{},cache:true,register:function(a){this.types["."+a.suffix]=a;window.steal&&steal.type(a.suffix+" view js",function(c,d,g){d=f.types["."+c.type];var h=e(c.rootSrc);c.text=d.script(h,c.text);g()})},types:{},ext:".ejs",registerScript:function(a,c,d){return"$.View.preload('"+c+"',"+f.types["."+a].script(c,d)+");"},preload:function(a,c){f.cached[a]=function(d,
g){return c.call(d,d,g)}}});window.steal&&steal.type("view js",function(a,c,d){c=f.types["."+a.type];var g=e(a.rootSrc);a.text="steal('"+(c.plugin||"jquery/view/"+a.type)+"').then(function($){$.View.preload('"+g+"',"+a.text+");\n})";d()});var y,t,z,A,u,B,v,D={val:true,text:true};y=function(a){var c=b.fn[a];b.fn[a]=function(){var d=j(arguments),g,h,i=this;if(k(d[0])){d[0].done(function(l){t.call(i,[l],c)});return this}else if(z(d)){if(g=B(d)){h=d[g];d[g]=function(l){t.call(i,[l],c);h.call(i,l)};f.apply(f,
