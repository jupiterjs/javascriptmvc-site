...
a.serialize?a.serialize():a},date:function(a){return a&&a.getTime()}}});var g=e.setup;e.setup=function(a,c,b){var f=this;g.call(f,a,c,b);d.each(["attributes","validations"],function(c,b){if(!f[b]||a[b]===f[b])f[b]={}});d.each(["convert","serialize"],function(b,c){a[c]!=f[c]&&(f[c]=d.extend({},a[c],f[c]))})}}});d.Observe.prototype.__convert=function(d,e){var g=this.constructor,a,c;g.attributes&&(a=g.attributes[d],c=g.convert[a]||g.convert["default"]);return null===e||!a?e:c.call(g,e,function(){},a)};
d.Observe.prototype.serialize=function(h){var e={},g=this.constructor,a={};h!=i?a[h]=this[h]:a=this.__get();d.each(a,function(a,b){var d=g.attributes[a],h=g.serialize[d];e[a]=b&&"function"==typeof b.serialize?b.serialize():h?h(b,d):b});return e}})(can={},this);
