...
E={"class":"className"},ya=d.each(["checked","disabled","readonly","required"],function(a,b){E[b]=b}),X=function(a,b,c){E[b]?a[E[b]]=-1<d.inArray(b,ya)?!0:c:a.setAttribute(b,c)},u=function(a,b,c,f){var e=f.matched===j;f.matched=!f.matched;d.each(a,function(a,b){f[b.obj._namespace+"|"+b.attr]?f[b.obj._namespace+"|"+b.attr].matched=f.matched:(b.matched=f.matched,f[b.obj._namespace+"|"+b.attr]=b,b.obj.bind(b.attr,c))});for(var g in f)a=f[g],"matched"!==g&&a.matched!==f.matched&&(a.obj.unbind(a.attr),
delete f[g]);e&&d.bind.call(b,"destroyed",function(){d.each(f,function(a,b){"boolean"!==typeof b&&b.obj.unbind(b.attr,c)})})},$a=function(a){return"string"==typeof a||"number"==typeof a?d.esc(a):Y(a)},Y=function(a){if("string"==typeof a)return a;if(!a&&0!=a)return"";var b=a.hookup&&function(b,d){a.hookup.call(a,b,d)}||"function"==typeof a&&a;return b?(A.push(b),""):""+a},F=function(a,b){d.Observe&&(d.Observe.__reading=function(a,b){c.push({obj:a,attr:b})});var c=[],f=a.call(b);d.Observe&&delete d.Observe.__reading;
return{value:f,observed:c}},q=function(a){if(this.constructor!=q){var b=new q(a);return function(a,d){return b.render(a,d)}}"function"==typeof a?this.template={fn:a}:(m(this,a),this.template=ab(this.text,this.name))};d.EJS=q;q.prototype.render=function(a,b){a=a||{};return this.template.fn.call(a,a,new q.Helpers(a,b||{}))};m(q,{txt:function(a,b,c,f,e){var g=F(e,f),h=g.observed,i=g.value,p={},b=Za[b]||"span";if(!h.length)return(a||0!==c?$a:Y)(i);if(0==c)return"<"+b+d.view.hook(a?function(a){var b=a.parentNode,
c=document.createTextNode(i),d=function(){var a=F(e,f);c.nodeValue=""+a.value;u(a.observed,b,d,p)};b.insertBefore(c,a);b.removeChild(a);u(h,b,d,p)}:function(a){var b=function(a,b){var c=d.view.frag(a),e=d.map(c.childNodes,function(a){return a}),f=b[b.length-1];f.nextSibling?f.parentNode.insertBefore(c,f.nextSibling):f.parentNode.appendChild(c);d.remove(d.$(b));return e},c=b(i,[a]),g=function(){var d=F(e,f);c=b(d.value,c);u(d.observed,a.parentNode,g,p)};u(h,a.parentNode,g,p)})+"></"+b+">";if(1===c){var k=
i.replace(/['"]/g,"").split("=")[0];A.push(function(a){var b=function(){var c=F(e,f),g=(c.value||"").replace(/['"]/g,"").split("="),h=g[0];if(h!=k&&k){var i=k;-1<d.inArray(i,ya)?a[i]=!1:a.removeAttribute(i)}h&&(X(a,h,g[1]),k=h);u(c.observed,a,b,p)};u(h,a,b,p)});return i}A.push(function(a){var b=d.$(a),g;(g=d.data(b,"hooks"))||d.data(b,"hooks",g={});var k=E[c]?a[E[c]]:a.getAttribute(c),b=k.split("__!!__"),n,l=function(b){if(b.batchNum===j||b.batchNum!==n.batchNum)n.batchNum=b.batchNum,X(a,c,n.render())};
g[c]?g[c].funcs.push({func:e,old:p}):g[c]={render:function(){var b=0;return k.replace(Ya,function(){var c=F(n.funcs[b].func,f);u(c.observed,a,l,n.funcs[b++].old);return Y(c.value)})},funcs:[{func:e,old:p}],batchNum:j};n=g[c];b.splice(1,0,i);X(a,c,b.join(""));u(h,a,l,p)});return"__!!__"},pending:function(){if(A.length){var a=A.slice(0);A=[];return d.view.hook(function(b){d.each(a,function(a,d){d(b)})})}return""}});var bb=RegExp("(<%%|%%>|<%==|<%=|<%#|<%|%>|<|>|\"|')","g"),B=null,L=s=null,A=[],ab=function(a,
b){var c=[],d=0,a=a.replace(Xa,"\n");a.replace(bb,function(b,e,g){g>d&&c.push(a.substring(d,g));c.push(e);d=g+e.length});0===d&&c.push(a);var e="",g=["var ___v1ew = [];"],h=function(a,b){g.push("___v1ew.push(",'"',a.split("\\").join("\\\\").split("\n").join("\\n").split('"').join('\\"').split("\t").join("\\t"),'"'+(b||"")+");")},i=[],k,l=null,o=!1,m="",q=[],r=0,n;for(B=s=L=null;(n=c[r++])!==j;){if(null===l)switch(n){case "<%":case "<%=":case "<%==":o=1;case "<%#":l=n;e.length&&h(e);e="";break;case "<%%":e+=
"<%";break;case "<":0!==c[r].indexOf("!--")&&(B=1,o=0);e+=n;break;case ">":B=0;o?(h(e,',can.EJS.pending(),">"'),e=""):e+=n;break;case "'":case '"':B&&(s&&s===n?s=null:null===s&&(s=n,L=k));default:"<"===k&&(m=n.split(" ")[0],0===m.indexOf("/")&&q.pop()===m.substr(1)?m=q[q.length-1]||m.substr(1):q.push(m)),e+=n}else switch(n){case "%>":switch(l){case "<%":k=--e.split("{").length- --e.split("}").length;1==k?(g.push("___v1ew.push(","can.EJS.txt(0,'"+m+"',"+(s?"'"+L.match(xa)[1]+"'":B?1:0)+",this,function(){",
"var ___v1ew = [];",e),i.push({before:"",after:"return ___v1ew.join('')}));"})):(d=i.length&&-1==k?i.pop():{after:";"},d.before&&g.push(d.before),g.push(e,";",d.after));break;case "<%=":case "<%==":(k=--e.split("{").length- --e.split("}").length)&&i.push({before:"return ___v1ew.join('')",after:"}));"}),wa.test(e)&&(e=e.match(wa),e="function(__){var "+e[1]+"=can.$(__);"+e[2]+"}"),g.push("___v1ew.push(","can.EJS.txt("+("<%="===l?1:0)+",'"+m+"',"+(s?"'"+L.match(xa)[1]+"'":B?1:0)+",this,function(){ return ",
e,k?"var ___v1ew = [];":"}));")}l=null;e="";break;case "<%%":e+="<%";break;default:e+=n}k=n}e.length&&h(e);g.push(";");h={out:"with(_VIEW) { with (_CONTEXT) {"+g.join("")+" return ___v1ew.join('')}}"};Wa.call(h,"this.fn = (function(_CONTEXT,_VIEW){"+h.out+"});\r\n//@ sourceURL="+b+".js");return h};q.Helpers=function(a,b){this._data=a;this._extras=b;m(this,b)};q.Helpers.prototype={list:function(a,b){a.attr("length");for(var c=0,d=a.length;c<d;c++)b(a[c],c,a)}};d.view.register({suffix:"ejs",script:function(a,
b){return"can.EJS(function(_CONTEXT,_VIEW) { "+(new q({text:b,name:a})).template.out+" })"},renderer:function(a,b){return q({text:b,name:a})}})})(can={},this);
