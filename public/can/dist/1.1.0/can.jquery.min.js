...
return a},hookups:{},hook:function(a){k.hookups[++ya]=a;return" data-view-id='"+ya+"'"},cached:{},cachedRenderers:{},cache:!0,register:function(a){this.types["."+a.suffix]=a},types:{},ext:".ejs",registerScript:function(){},preload:function(){},render:function(a,b,d,e){D(d)&&(e=d,d=l);var f=Za(b);if(f.length){var h=new c.Deferred;f.push(za(a,!0));c.when.apply(c,f).then(function(a){var f=Ya(arguments),g=f.pop();if(c.isDeferred(b))b=Aa(a);else for(var j in b)c.isDeferred(b[j])&&(b[j]=Aa(f.shift()));
f=g(b,d);h.resolve(f);e&&e(f)});return h}var g,f=D(e),h=za(a,f);if(f)g=h,h.then(function(a){e(b?a(b,d):a)});else{if("resolved"===h.state()&&h.__view_id)return a=k.cachedRenderers[h.__view_id],b?a(b,d):a;h.then(function(a){g=b?a(b,d):a})}return g},registerView:function(a,b,d,e){b=(d||k.types[k.ext]).renderer(a,b);e=e||new c.Deferred;k.cache&&(k.cached[a]=e,e.__view_id=a,k.cachedRenderers[a]=b);return e.resolve(b)}});var Ba=function(a,b){if(!a.length)throw"can.view: No template or empty template:"+
