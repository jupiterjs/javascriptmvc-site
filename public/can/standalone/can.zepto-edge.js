...
;
    ...
    var table = document.createElement("table"), tableRow = document.createElement("tr"), containers = {"tr":document.createElement("tbody"), "tbody":table, "thead":table, "tfoot":table, "td":tableRow, "th":tableRow, "*":document.createElement("div")}, fragmentRE = /^\s*<(\w+)[^>]*>/, fragment = function (html, name) {
        if (name === undefined) {
    ...
    can.buildFragment = function (htmls, nodes) {
        var parts = fragment(htmls[0]), frag = document.createDocumentFragment();
    ...
    can.bind = function (ev, cb) {
        if (this.bind) {
            ...
            if (arrHas(this, "addEventListener")) {
                $([this]).bind(ev, cb);
            } else {
