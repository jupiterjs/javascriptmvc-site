...
;
steal.loaded('cookbook/cookbook.js');
// steal model files
steal('./recipe.js', "jquery/model");
steal.loaded('cookbook/models/models.js');
...
steal.loaded('cookbook/fixtures/fixtures.js');
...
steal.loaded('cookbook/recipe/list/list.js');
...
steal.loaded('cookbook/models/recipe.js');
